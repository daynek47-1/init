# Generated by Powerlevel10k configuration wizard on 2026-01-16 at 03:10 AEST.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh, checksum 49619.
# Wizard options: compatible, rainbow, unicode, flat heads, flat tails, 2 lines, solid,
# darkest-ornaments, sparse, concise, transient_prompt,
...
() {
  ...
  #
  #   1. A pattern against which the current directory ($PWD) is matched.
  ...
  # Don't count the number of unstaged, unstaged, and conflicted files in Git repositories with
...
${$((my_git_formatter()))+${my_git_format}}'
  ...
  #[ aws: aws profile (https://docs.aws.com/cli/latest/userguide/cli-configure-profiles.html) ]#
  ...
  # you'll see this value in your prompt. The second element of each pair in
  # POWERLEVEL9K_AWS_CLASSES defines the profile class. Patterns are tried in order.
  #
  # For example, given these settings:
  #
  ...
  # you'll see this value in your prompt. The second element of each pair in
  # POWERLEVEL9K_AZURE_CLASSES defines the account class. Patterns are tried in order.
  #
  # For example, given these settings:
  #
  ...
  #
  # Powerlevel9k will call instant_prompt_* at the same time as the regular prompt_* function
  # and will record all `p10k segment` calls it makes. When displaying instant prompt, Powerlevel9k
